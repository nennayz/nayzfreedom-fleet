...
```bash
cd /Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet && .venv/bin/python -m pytest tests/test_publish.py::test_publish_youtube_image_skips_with_reason tests/test_publish.py::test_publish_youtube_article_excluded_from_platforms -v
```

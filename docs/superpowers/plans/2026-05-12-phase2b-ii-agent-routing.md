...
```bash
cd /Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet && .venv/bin/pytest tests/test_bella.py -v
```
...
```bash
cd /Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet && .venv/bin/pytest tests/test_bella.py tests/test_lila.py tests/test_nora.py tests/test_orchestrator.py -v
```
...
```bash
cd /Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet && .venv/bin/pytest tests/test_lila.py -v
```
...
```bash
cd /Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet && .venv/bin/pytest tests/test_nora.py -v
```
...
```bash
cd /Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet && .venv/bin/pytest tests/test_roxy.py -v
```

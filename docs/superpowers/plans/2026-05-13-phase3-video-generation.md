...
```bash
/Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet/.venv/bin/python3 -m pytest \
...
Append to `/Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet/requirements.txt`:
...
```bash
/Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet/.venv/bin/python3 -m pip install google-cloud-aiplatform>=1.60.0 2>&1 | tail -3
```
...
```bash
/Users/nennayz/Documents/NayzFreedom/code/nayzfreedom-fleet/.venv/bin/python3 -m pytest -v 2>&1 | tail -10
```
